...
@app_view.post("/age/changer/")
async def AgeChanger(file: UploadFile = File(...)):
    try:
...
def get_job_status(job_id: str):
    ...
    try:
        ...
        # Decode Base64
        image_bytes = base64.b64decode(job_id.get("result"))
...
@app_view.get("/text/img/style")
def text_2_img_style():
    return text2img_style

@app_view.post("/text/img")
